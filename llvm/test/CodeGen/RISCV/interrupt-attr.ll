...
; CHECK-RV32-F-ILP3-NEXT:    sw a0, 188(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a1, 184(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a2, 180(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a3, 176(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a4, 172(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a5, 168(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a6, 164(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw a7, 160(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw t3, 156(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw t4, 152(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw t5, 148(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    sw t6, 144(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft0, 140(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft1, 136(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft2, 132(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft3, 128(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft4, 124(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft5, 120(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft6, 116(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft7, 112(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs0, 108(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs1, 104(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa0, 100(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa1, 96(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa2, 92(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa3, 88(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa4, 84(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa5, 80(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa6, 76(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fa7, 72(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs2, 68(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs3, 64(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs4, 60(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs5, 56(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs6, 52(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs7, 48(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs8, 44(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs9, 40(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs10, 36(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw fs11, 32(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft8, 28(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft9, 24(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft10, 20(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    fsw ft11, 16(sp) # 4-byte Folded Spill
; CHECK-RV32-F-ILP3-NEXT:    frcsr t0
; CHECK-RV32-F-ILP3-NEXT:    sw t0, 12(sp)
; CHECK-RV32-F-ILP3-NEXT:    call otherfoo
; CHECK-RV32-F-ILP3-NEXT:    lw t0, 12(sp)
; CHECK-RV32-F-ILP3-NEXT:    fscsr t0
...
; CHECK-RV32-F-ILP3-NEXT:    lw a0, 188(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a1, 184(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a2, 180(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a3, 176(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a4, 172(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a5, 168(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a6, 164(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw a7, 160(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw t3, 156(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw t4, 152(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw t5, 148(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw t6, 144(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft0, 140(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft1, 136(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft2, 132(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft3, 128(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft4, 124(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft5, 120(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft6, 116(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft7, 112(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs0, 108(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs1, 104(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa0, 100(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa1, 96(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa2, 92(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa3, 88(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa4, 84(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa5, 80(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa6, 76(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fa7, 72(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs2, 68(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs3, 64(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs4, 60(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs5, 56(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs6, 52(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs7, 48(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs8, 44(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs9, 40(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs10, 36(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw fs11, 32(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft8, 28(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft9, 24(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft10, 20(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    flw ft11, 16(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    addi sp, sp, 208
...
; CHECK-RV32-FD-ILP32F-NEXT:    sw a0, 316(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a1, 312(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a2, 308(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a3, 304(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a4, 300(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a5, 296(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a6, 292(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw a7, 288(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw t3, 284(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw t4, 280(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw t5, 276(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    sw t6, 272(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft0, 264(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft1, 256(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft2, 248(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft3, 240(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft4, 232(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft5, 224(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft6, 216(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft7, 208(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs0, 200(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs1, 192(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa0, 184(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa1, 176(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa2, 168(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa3, 160(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa4, 152(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa5, 144(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa6, 136(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fa7, 128(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs2, 120(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs3, 112(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs4, 104(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs5, 96(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs6, 88(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs7, 80(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs8, 72(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs9, 64(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs10, 56(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd fs11, 48(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft8, 40(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft9, 32(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft10, 24(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    fsd ft11, 16(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32F-NEXT:    frcsr t0
; CHECK-RV32-FD-ILP32F-NEXT:    sw t0, 12(sp)
; CHECK-RV32-FD-ILP32F-NEXT:    call otherfoo
; CHECK-RV32-FD-ILP32F-NEXT:    lw t0, 12(sp)
; CHECK-RV32-FD-ILP32F-NEXT:    fscsr t0
...
; CHECK-RV32-FD-ILP32F-NEXT:    lw a0, 316(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a1, 312(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a2, 308(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a3, 304(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a4, 300(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a5, 296(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a6, 292(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw a7, 288(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw t3, 284(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw t4, 280(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw t5, 276(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw t6, 272(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft0, 264(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft1, 256(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft2, 248(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft3, 240(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft4, 232(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft5, 224(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft6, 216(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft7, 208(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs0, 200(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs1, 192(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa0, 184(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa1, 176(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa2, 168(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa3, 160(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa4, 152(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa5, 144(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa6, 136(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fa7, 128(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs2, 120(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs3, 112(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs4, 104(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs5, 96(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs6, 88(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs7, 80(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs8, 72(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs9, 64(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs10, 56(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld fs11, 48(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft8, 40(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft9, 32(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft10, 24(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    fld ft11, 16(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    addi sp, sp, 336
...
; CHECK-RV32-FD-ILP32-NEXT:    sw a0, 316(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a1, 312(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a2, 308(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a3, 304(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a4, 300(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a5, 296(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a6, 292(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw a7, 288(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw t3, 284(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw t4, 280(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw t5, 276(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    sw t6, 272(sp) # 4-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft0, 264(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft1, 256(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft2, 248(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft3, 240(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft4, 232(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft5, 224(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft6, 216(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft7, 208(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs0, 200(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs1, 192(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa0, 184(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa1, 176(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa2, 168(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa3, 160(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa4, 152(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa5, 144(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa6, 136(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fa7, 128(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs2, 120(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs3, 112(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs4, 104(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs5, 96(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs6, 88(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs7, 80(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs8, 72(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs9, 64(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs10, 56(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd fs11, 48(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft8, 40(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft9, 32(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft10, 24(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    fsd ft11, 16(sp) # 8-byte Folded Spill
; CHECK-RV32-FD-ILP32-NEXT:    frcsr t0
; CHECK-RV32-FD-ILP32-NEXT:    sw t0, 12(sp)
; CHECK-RV32-FD-ILP32-NEXT:    call otherfoo
; CHECK-RV32-FD-ILP32-NEXT:    lw t0, 12(sp)
; CHECK-RV32-FD-ILP32-NEXT:    fscsr t0
...
; CHECK-RV32-FD-ILP32-NEXT:    lw a0, 316(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a1, 312(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a2, 308(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a3, 304(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a4, 300(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a5, 296(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a6, 292(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw a7, 288(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw t3, 284(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw t4, 280(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw t5, 276(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw t6, 272(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft0, 264(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft1, 256(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft2, 248(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft3, 240(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft4, 232(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft5, 224(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft6, 216(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft7, 208(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs0, 200(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs1, 192(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa0, 184(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa1, 176(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa2, 168(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa3, 160(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa4, 152(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa5, 144(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa6, 136(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fa7, 128(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs2, 120(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs3, 112(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs4, 104(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs5, 96(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs6, 88(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs7, 80(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs8, 72(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs9, 64(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs10, 56(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld fs11, 48(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft8, 40(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft9, 32(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft10, 24(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    fld ft11, 16(sp) # 8-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    addi sp, sp, 336
...
; CHECK-RV32E-F-NEXT:    sw a0, 152(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a1, 148(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a2, 144(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a3, 140(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a4, 136(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a5, 132(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft0, 128(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft1, 124(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft2, 120(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft3, 116(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft4, 112(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft5, 108(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft6, 104(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft7, 100(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs0, 96(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs1, 92(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa0, 88(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa1, 84(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa2, 80(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa3, 76(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa4, 72(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa5, 68(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa6, 64(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fa7, 60(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs2, 56(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs3, 52(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs4, 48(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs5, 44(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs6, 40(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs7, 36(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs8, 32(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs9, 28(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs10, 24(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw fs11, 20(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft8, 16(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft9, 12(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft10, 8(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    fsw ft11, 4(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    frcsr t0
; CHECK-RV32E-F-NEXT:    sw t0, 0(sp)
; CHECK-RV32E-F-NEXT:    call otherfoo
; CHECK-RV32E-F-NEXT:    lw t0, 0(sp)
; CHECK-RV32E-F-NEXT:    fscsr t0
...
; CHECK-RV32E-F-NEXT:    lw a0, 152(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a1, 148(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a2, 144(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a3, 140(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a4, 136(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a5, 132(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft0, 128(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft1, 124(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft2, 120(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft3, 116(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft4, 112(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft5, 108(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft6, 104(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft7, 100(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs0, 96(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs1, 92(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa0, 88(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa1, 84(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa2, 80(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa3, 76(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa4, 72(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa5, 68(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa6, 64(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fa7, 60(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs2, 56(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs3, 52(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs4, 48(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs5, 44(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs6, 40(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs7, 36(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs8, 32(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs9, 28(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs10, 24(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw fs11, 20(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft8, 16(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft9, 12(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft10, 8(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    flw ft11, 4(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    addi sp, sp, 172
...
; CHECK-RV64-F-NEXT:    sd a0, 184(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a1, 176(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a2, 168(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a3, 160(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a4, 152(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a5, 144(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a6, 136(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd a7, 128(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t3, 120(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t4, 112(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t5, 104(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    sd t6, 96(sp) # 8-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft0, 92(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft1, 88(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft2, 84(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft3, 80(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft4, 76(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft5, 72(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft6, 68(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft7, 64(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa0, 60(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa1, 56(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa2, 52(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa3, 48(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa4, 44(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa5, 40(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa6, 36(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw fa7, 32(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft8, 28(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft9, 24(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft10, 20(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    fsw ft11, 16(sp) # 4-byte Folded Spill
; CHECK-RV64-F-NEXT:    frcsr t0
; CHECK-RV64-F-NEXT:    sd t0, 8(sp)
; CHECK-RV64-F-NEXT:    call otherfoo
; CHECK-RV64-F-NEXT:    ld t0, 8(sp)
; CHECK-RV64-F-NEXT:    fscsr t0
...
; CHECK-RV64-F-NEXT:    ld a0, 184(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a1, 176(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a2, 168(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a3, 160(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a4, 152(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a5, 144(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a6, 136(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld a7, 128(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t3, 120(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t4, 112(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t5, 104(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t6, 96(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft0, 92(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft1, 88(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft2, 84(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft3, 80(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft4, 76(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft5, 72(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft6, 68(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft7, 64(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa0, 60(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa1, 56(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa2, 52(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa3, 48(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa4, 44(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa5, 40(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa6, 36(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw fa7, 32(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft8, 28(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft9, 24(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft10, 20(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    flw ft11, 16(sp) # 4-byte Folded Reload
; CHECK-RV64-F-NEXT:    addi sp, sp, 224
...
; CHECK-RV64-FD-NEXT:    sd a0, 264(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a1, 256(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a2, 248(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a3, 240(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a4, 232(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a5, 224(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a6, 216(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd a7, 208(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t3, 200(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t4, 192(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t5, 184(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    sd t6, 176(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft0, 168(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft1, 160(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft2, 152(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft3, 144(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft4, 136(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft5, 128(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft6, 120(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft7, 112(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa0, 104(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa1, 96(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa2, 88(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa3, 80(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa4, 72(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa5, 64(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa6, 56(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd fa7, 48(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft8, 40(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft9, 32(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft10, 24(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    fsd ft11, 16(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-NEXT:    frcsr t0
; CHECK-RV64-FD-NEXT:    sd t0, 8(sp)
; CHECK-RV64-FD-NEXT:    call otherfoo
; CHECK-RV64-FD-NEXT:    ld t0, 8(sp)
; CHECK-RV64-FD-NEXT:    fscsr t0
...
; CHECK-RV64-FD-NEXT:    ld a0, 264(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a1, 256(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a2, 248(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a3, 240(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a4, 232(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a5, 224(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a6, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld a7, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t3, 200(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t4, 192(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t5, 184(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t6, 176(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft0, 168(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft1, 160(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft2, 152(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft3, 144(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft4, 136(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft5, 128(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft6, 120(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft7, 112(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa0, 104(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa1, 96(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa2, 88(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa3, 80(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa4, 72(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa5, 64(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa6, 56(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld fa7, 48(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft8, 40(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft9, 32(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft10, 24(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    fld ft11, 16(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    addi sp, sp, 304
...
; CHECK-RV64-F-LP64-NEXT:    sd a0, 232(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a1, 224(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a2, 216(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a3, 208(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a4, 200(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a5, 192(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a6, 184(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd a7, 176(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd t3, 168(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd t4, 160(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd t5, 152(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    sd t6, 144(sp) # 8-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft0, 140(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft1, 136(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft2, 132(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft3, 128(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft4, 124(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft5, 120(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft6, 116(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft7, 112(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs0, 108(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs1, 104(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa0, 100(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa1, 96(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa2, 92(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa3, 88(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa4, 84(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa5, 80(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa6, 76(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fa7, 72(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs2, 68(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs3, 64(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs4, 60(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs5, 56(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs6, 52(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs7, 48(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs8, 44(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs9, 40(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs10, 36(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw fs11, 32(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft8, 28(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft9, 24(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft10, 20(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    fsw ft11, 16(sp) # 4-byte Folded Spill
; CHECK-RV64-F-LP64-NEXT:    frcsr t0
; CHECK-RV64-F-LP64-NEXT:    sd t0, 8(sp)
; CHECK-RV64-F-LP64-NEXT:    call otherfoo
; CHECK-RV64-F-LP64-NEXT:    ld t0, 8(sp)
; CHECK-RV64-F-LP64-NEXT:    fscsr t0
...
; CHECK-RV64-F-LP64-NEXT:    ld a0, 232(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a1, 224(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a2, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a3, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a4, 200(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a5, 192(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a6, 184(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld a7, 176(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld t3, 168(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld t4, 160(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld t5, 152(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld t6, 144(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft0, 140(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft1, 136(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft2, 132(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft3, 128(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft4, 124(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft5, 120(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft6, 116(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft7, 112(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs0, 108(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs1, 104(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa0, 100(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa1, 96(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa2, 92(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa3, 88(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa4, 84(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa5, 80(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa6, 76(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fa7, 72(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs2, 68(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs3, 64(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs4, 60(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs5, 56(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs6, 52(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs7, 48(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs8, 44(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs9, 40(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs10, 36(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw fs11, 32(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft8, 28(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft9, 24(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft10, 20(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    flw ft11, 16(sp) # 4-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    addi sp, sp, 272
...
; CHECK-RV64-FD-LP64F-NEXT:    sd a0, 360(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a1, 352(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a2, 344(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a3, 336(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a4, 328(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a5, 320(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a6, 312(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd a7, 304(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd t3, 296(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd t4, 288(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd t5, 280(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    sd t6, 272(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft0, 264(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft1, 256(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft2, 248(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft3, 240(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft4, 232(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft5, 224(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft6, 216(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft7, 208(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs0, 200(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs1, 192(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa0, 184(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa1, 176(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa2, 168(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa3, 160(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa4, 152(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa5, 144(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa6, 136(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fa7, 128(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs2, 120(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs3, 112(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs4, 104(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs5, 96(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs6, 88(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs7, 80(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs8, 72(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs9, 64(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs10, 56(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd fs11, 48(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft8, 40(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft9, 32(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft10, 24(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    fsd ft11, 16(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64F-NEXT:    frcsr t0
; CHECK-RV64-FD-LP64F-NEXT:    sd t0, 8(sp)
; CHECK-RV64-FD-LP64F-NEXT:    call otherfoo
; CHECK-RV64-FD-LP64F-NEXT:    ld t0, 8(sp)
; CHECK-RV64-FD-LP64F-NEXT:    fscsr t0
...
; CHECK-RV64-FD-LP64F-NEXT:    ld a0, 360(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a1, 352(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a2, 344(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a3, 336(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a4, 328(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a5, 320(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a6, 312(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld a7, 304(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld t3, 296(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld t4, 288(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld t5, 280(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld t6, 272(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft0, 264(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft1, 256(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft2, 248(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft3, 240(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft4, 232(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft5, 224(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft6, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft7, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs0, 200(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs1, 192(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa0, 184(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa1, 176(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa2, 168(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa3, 160(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa4, 152(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa5, 144(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa6, 136(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fa7, 128(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs2, 120(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs3, 112(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs4, 104(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs5, 96(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs6, 88(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs7, 80(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs8, 72(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs9, 64(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs10, 56(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld fs11, 48(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft8, 40(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft9, 32(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft10, 24(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    fld ft11, 16(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    addi sp, sp, 400
...
; CHECK-RV64-FD-LP64-NEXT:    sd a0, 360(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a1, 352(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a2, 344(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a3, 336(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a4, 328(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a5, 320(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a6, 312(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd a7, 304(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd t3, 296(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd t4, 288(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd t5, 280(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    sd t6, 272(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft0, 264(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft1, 256(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft2, 248(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft3, 240(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft4, 232(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft5, 224(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft6, 216(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft7, 208(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs0, 200(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs1, 192(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa0, 184(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa1, 176(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa2, 168(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa3, 160(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa4, 152(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa5, 144(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa6, 136(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fa7, 128(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs2, 120(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs3, 112(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs4, 104(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs5, 96(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs6, 88(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs7, 80(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs8, 72(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs9, 64(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs10, 56(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd fs11, 48(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft8, 40(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft9, 32(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft10, 24(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    fsd ft11, 16(sp) # 8-byte Folded Spill
; CHECK-RV64-FD-LP64-NEXT:    frcsr t0
; CHECK-RV64-FD-LP64-NEXT:    sd t0, 8(sp)
; CHECK-RV64-FD-LP64-NEXT:    call otherfoo
; CHECK-RV64-FD-LP64-NEXT:    ld t0, 8(sp)
; CHECK-RV64-FD-LP64-NEXT:    fscsr t0
...
; CHECK-RV64-FD-LP64-NEXT:    ld a0, 360(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a1, 352(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a2, 344(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a3, 336(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a4, 328(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a5, 320(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a6, 312(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld a7, 304(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld t3, 296(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld t4, 288(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld t5, 280(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld t6, 272(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft0, 264(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft1, 256(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft2, 248(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft3, 240(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft4, 232(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft5, 224(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft6, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft7, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs0, 200(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs1, 192(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa0, 184(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa1, 176(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa2, 168(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa3, 160(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa4, 152(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa5, 144(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa6, 136(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fa7, 128(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs2, 120(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs3, 112(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs4, 104(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs5, 96(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs6, 88(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs7, 80(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs8, 72(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs9, 64(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs10, 56(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld fs11, 48(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft8, 40(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft9, 32(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft10, 24(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    fld ft11, 16(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    addi sp, sp, 400
...
; CHECK-RV64E-F-NEXT:    sd a0, 176(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a1, 168(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a2, 160(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a3, 152(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a4, 144(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a5, 136(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft0, 132(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft1, 128(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft2, 124(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft3, 120(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft4, 116(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft5, 112(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft6, 108(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft7, 104(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs0, 100(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs1, 96(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa0, 92(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa1, 88(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa2, 84(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa3, 80(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa4, 76(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa5, 72(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa6, 68(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fa7, 64(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs2, 60(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs3, 56(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs4, 52(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs5, 48(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs6, 44(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs7, 40(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs8, 36(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs9, 32(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs10, 28(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw fs11, 24(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft8, 20(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft9, 16(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft10, 12(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    fsw ft11, 8(sp) # 4-byte Folded Spill
; CHECK-RV64E-F-NEXT:    frcsr t0
; CHECK-RV64E-F-NEXT:    sd t0, 0(sp)
; CHECK-RV64E-F-NEXT:    call otherfoo
; CHECK-RV64E-F-NEXT:    ld t0, 0(sp)
; CHECK-RV64E-F-NEXT:    fscsr t0
...
; CHECK-RV64E-F-NEXT:    ld a0, 176(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a1, 168(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a2, 160(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a3, 152(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a4, 144(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a5, 136(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft0, 132(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft1, 128(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft2, 124(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft3, 120(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft4, 116(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft5, 112(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft6, 108(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft7, 104(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs0, 100(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs1, 96(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa0, 92(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa1, 88(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa2, 84(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa3, 80(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa4, 76(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa5, 72(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa6, 68(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fa7, 64(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs2, 60(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs3, 56(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs4, 52(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs5, 48(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs6, 44(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs7, 40(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs8, 36(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs9, 32(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs10, 28(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw fs11, 24(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft8, 20(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft9, 16(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft10, 12(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    flw ft11, 8(sp) # 4-byte Folded Reload
; CHECK-RV64E-F-NEXT:    addi sp, sp, 216
...
; CHECK-RV64E-FD-NEXT:    sd a0, 432(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a1, 424(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a2, 416(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a3, 408(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a4, 400(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a5, 392(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a6, 384(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a7, 376(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s2, 368(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s3, 360(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s4, 352(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s5, 344(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s6, 336(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s7, 328(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s8, 320(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s9, 312(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s10, 304(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s11, 296(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t3, 288(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t4, 280(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t5, 272(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t6, 264(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft0, 256(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft1, 248(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft2, 240(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft3, 232(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft4, 224(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft5, 216(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft6, 208(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft7, 200(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs0, 192(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs1, 184(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa0, 176(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa1, 168(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa2, 160(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa3, 152(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa4, 144(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa5, 136(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa6, 128(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fa7, 120(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs2, 112(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs3, 104(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs4, 96(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs5, 88(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs6, 80(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs7, 72(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs8, 64(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs9, 56(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs10, 48(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd fs11, 40(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft8, 32(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft9, 24(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft10, 16(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    fsd ft11, 8(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    frcsr t0
; CHECK-RV64E-FD-NEXT:    sd t0, 0(sp)
; CHECK-RV64E-FD-NEXT:    call otherfoo
; CHECK-RV64E-FD-NEXT:    ld t0, 0(sp)
; CHECK-RV64E-FD-NEXT:    fscsr t0
...
; CHECK-RV64E-FD-NEXT:    ld a0, 432(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a1, 424(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a2, 416(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a3, 408(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a4, 400(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a5, 392(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a6, 384(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a7, 376(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s2, 368(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s3, 360(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s4, 352(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s5, 344(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s6, 336(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s7, 328(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s8, 320(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s9, 312(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s10, 304(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s11, 296(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t3, 288(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t4, 280(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t5, 272(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t6, 264(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft0, 256(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft1, 248(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft2, 240(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft3, 232(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft4, 224(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft5, 216(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft6, 208(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft7, 200(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs0, 192(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs1, 184(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa0, 176(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa1, 168(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa2, 160(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa3, 152(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa4, 144(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa5, 136(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa6, 128(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fa7, 120(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs2, 112(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs3, 104(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs4, 96(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs5, 88(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs6, 80(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs7, 72(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs8, 64(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs9, 56(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs10, 48(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld fs11, 40(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft8, 32(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft9, 24(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft10, 16(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    fld ft11, 8(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    addi sp, sp, 472
...
; CHECK-RV32-F-ILP3-NEXT:    frcsr t0
; CHECK-RV32-F-ILP3-NEXT:    sw t0, 8(sp)
; CHECK-RV32-F-ILP3-NEXT:    addi s0, sp, 208
; CHECK-RV32-F-ILP3-NEXT:    call otherfoo
; CHECK-RV32-F-ILP3-NEXT:    lw t0, 8(sp)
; CHECK-RV32-F-ILP3-NEXT:    fscsr t0
; CHECK-RV32-F-ILP3-NEXT:    lw ra, 204(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw t0, 200(sp) # 4-byte Folded Reload
; CHECK-RV32-F-ILP3-NEXT:    lw t1, 196(sp) # 4-byte Folded Reload
...
; CHECK-RV32-FD-ILP32F-NEXT:    frcsr t0
; CHECK-RV32-FD-ILP32F-NEXT:    sw t0, 4(sp)
; CHECK-RV32-FD-ILP32F-NEXT:    addi s0, sp, 336
; CHECK-RV32-FD-ILP32F-NEXT:    call otherfoo
; CHECK-RV32-FD-ILP32F-NEXT:    lw t0, 4(sp)
; CHECK-RV32-FD-ILP32F-NEXT:    fscsr t0
; CHECK-RV32-FD-ILP32F-NEXT:    lw ra, 332(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw t0, 328(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32F-NEXT:    lw t1, 324(sp) # 4-byte Folded Reload
...
; CHECK-RV32-FD-ILP32-NEXT:    frcsr t0
; CHECK-RV32-FD-ILP32-NEXT:    sw t0, 4(sp)
; CHECK-RV32-FD-ILP32-NEXT:    addi s0, sp, 336
; CHECK-RV32-FD-ILP32-NEXT:    call otherfoo
; CHECK-RV32-FD-ILP32-NEXT:    lw t0, 4(sp)
; CHECK-RV32-FD-ILP32-NEXT:    fscsr t0
; CHECK-RV32-FD-ILP32-NEXT:    lw ra, 332(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw t0, 328(sp) # 4-byte Folded Reload
; CHECK-RV32-FD-ILP32-NEXT:    lw t1, 324(sp) # 4-byte Folded Reload
...
; CHECK-RV32E-F:       # %bb.0:
; CHECK-RV32E-F-NEXT:    addi sp, sp, -176
; CHECK-RV32E-F-NEXT:    sw ra, 172(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw t0, 168(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw t1, 164(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw t2, 160(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw s0, 156(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a0, 152(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a1, 148(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a2, 144(sp) # 4-byte Folded Spill
; CHECK-RV32E-F-NEXT:    sw a3, 140(sp) # 4-byte Folded Spill
...
; CHECK-RV32E-F-NEXT:    frcsr t0
; CHECK-RV32E-F-NEXT:    sw t0, 0(sp)
; CHECK-RV32E-F-NEXT:    addi s0, sp, 176
; CHECK-RV32E-F-NEXT:    call otherfoo
; CHECK-RV32E-F-NEXT:    lw t0, 0(sp)
; CHECK-RV32E-F-NEXT:    fscsr t0
; CHECK-RV32E-F-NEXT:    lw ra, 172(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw t0, 168(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw t1, 164(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw t2, 160(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw s0, 156(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a0, 152(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a1, 148(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a2, 144(sp) # 4-byte Folded Reload
; CHECK-RV32E-F-NEXT:    lw a3, 140(sp) # 4-byte Folded Reload
...
; CHECK-RV64-F-NEXT:    frcsr t0
; CHECK-RV64-F-NEXT:    sd t0, 0(sp)
; CHECK-RV64-F-NEXT:    addi s0, sp, 224
; CHECK-RV64-F-NEXT:    call otherfoo
; CHECK-RV64-F-NEXT:    ld t0, 0(sp)
; CHECK-RV64-F-NEXT:    fscsr t0
; CHECK-RV64-F-NEXT:    ld ra, 216(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t0, 208(sp) # 8-byte Folded Reload
; CHECK-RV64-F-NEXT:    ld t1, 200(sp) # 8-byte Folded Reload
...
; CHECK-RV64-FD-NEXT:    frcsr t0
; CHECK-RV64-FD-NEXT:    sd t0, 0(sp)
; CHECK-RV64-FD-NEXT:    addi s0, sp, 304
; CHECK-RV64-FD-NEXT:    call otherfoo
; CHECK-RV64-FD-NEXT:    ld t0, 0(sp)
; CHECK-RV64-FD-NEXT:    fscsr t0
; CHECK-RV64-FD-NEXT:    ld ra, 296(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t0, 288(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-NEXT:    ld t1, 280(sp) # 8-byte Folded Reload
...
; CHECK-RV64-F-LP64-NEXT:    frcsr t0
; CHECK-RV64-F-LP64-NEXT:    sd t0, 0(sp)
; CHECK-RV64-F-LP64-NEXT:    addi s0, sp, 272
; CHECK-RV64-F-LP64-NEXT:    call otherfoo
; CHECK-RV64-F-LP64-NEXT:    ld t0, 0(sp)
; CHECK-RV64-F-LP64-NEXT:    fscsr t0
; CHECK-RV64-F-LP64-NEXT:    ld ra, 264(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld t0, 256(sp) # 8-byte Folded Reload
; CHECK-RV64-F-LP64-NEXT:    ld t1, 248(sp) # 8-byte Folded Reload
...
; CHECK-RV64-FD-LP64F-NEXT:    frcsr t0
; CHECK-RV64-FD-LP64F-NEXT:    sd t0, 0(sp)
; CHECK-RV64-FD-LP64F-NEXT:    addi s0, sp, 400
; CHECK-RV64-FD-LP64F-NEXT:    call otherfoo
; CHECK-RV64-FD-LP64F-NEXT:    ld t0, 0(sp)
; CHECK-RV64-FD-LP64F-NEXT:    fscsr t0
; CHECK-RV64-FD-LP64F-NEXT:    ld ra, 392(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld t0, 384(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64F-NEXT:    ld t1, 376(sp) # 8-byte Folded Reload
...
; CHECK-RV64-FD-LP64-NEXT:    frcsr t0
; CHECK-RV64-FD-LP64-NEXT:    sd t0, 0(sp)
; CHECK-RV64-FD-LP64-NEXT:    addi s0, sp, 400
; CHECK-RV64-FD-LP64-NEXT:    call otherfoo
; CHECK-RV64-FD-LP64-NEXT:    ld t0, 0(sp)
; CHECK-RV64-FD-LP64-NEXT:    fscsr t0
; CHECK-RV64-FD-LP64-NEXT:    ld ra, 392(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld t0, 384(sp) # 8-byte Folded Reload
; CHECK-RV64-FD-LP64-NEXT:    ld t1, 376(sp) # 8-byte Folded Reload
...
; CHECK-RV64E-F:       # %bb.0:
; CHECK-RV64E-F-NEXT:    addi sp, sp, -224
; CHECK-RV64E-F-NEXT:    sd ra, 216(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd t0, 208(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd t1, 200(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd t2, 192(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd s0, 184(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a0, 176(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a1, 168(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a2, 160(sp) # 8-byte Folded Spill
; CHECK-RV64E-F-NEXT:    sd a3, 152(sp) # 8-byte Folded Spill
...
; CHECK-RV64E-F-NEXT:    frcsr t0
; CHECK-RV64E-F-NEXT:    sd t0, 0(sp)
; CHECK-RV64E-F-NEXT:    addi s0, sp, 224
; CHECK-RV64E-F-NEXT:    call otherfoo
; CHECK-RV64E-F-NEXT:    ld t0, 0(sp)
; CHECK-RV64E-F-NEXT:    fscsr t0
; CHECK-RV64E-F-NEXT:    ld ra, 216(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld t0, 208(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld t1, 200(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld t2, 192(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld s0, 184(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a0, 176(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a1, 168(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a2, 160(sp) # 8-byte Folded Reload
; CHECK-RV64E-F-NEXT:    ld a3, 152(sp) # 8-byte Folded Reload
...
; CHECK-RV64E-FD:       # %bb.0:
; CHECK-RV64E-FD-NEXT:    addi sp, sp, -480
; CHECK-RV64E-FD-NEXT:    sd ra, 472(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t0, 464(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t1, 456(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd t2, 448(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd s0, 440(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a0, 432(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a1, 424(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a2, 416(sp) # 8-byte Folded Spill
; CHECK-RV64E-FD-NEXT:    sd a3, 408(sp) # 8-byte Folded Spill
...
; CHECK-RV64E-FD-NEXT:    frcsr t0
; CHECK-RV64E-FD-NEXT:    sd t0, 0(sp)
; CHECK-RV64E-FD-NEXT:    addi s0, sp, 480
; CHECK-RV64E-FD-NEXT:    call otherfoo
; CHECK-RV64E-FD-NEXT:    ld t0, 0(sp)
; CHECK-RV64E-FD-NEXT:    fscsr t0
; CHECK-RV64E-FD-NEXT:    ld ra, 472(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t0, 464(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t1, 456(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld t2, 448(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld s0, 440(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a0, 432(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a1, 424(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a2, 416(sp) # 8-byte Folded Reload
; CHECK-RV64E-FD-NEXT:    ld a3, 408(sp) # 8-byte Folded Reload
